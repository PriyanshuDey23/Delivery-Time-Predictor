...
from Delivery_Time_Predictor.pipeline.prediction_pipeline import CustomData, PredictPipeline
import os
...
from Delivery_Time_Predictor.pipeline.training_pipeline import Train
...
app = application
ALLOWED_EXTENSIONS = {'csv'} # For csv file
