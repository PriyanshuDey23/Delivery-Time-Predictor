...
class Feature_Engineering(BaseEstimator, TransformerMixin):
    ...
    def transform_data(self, df):
        try:
            ...
            # Calculate the distance between seller and receiver location
    ...
    def transform(self,X:pd.DataFrame,y=None):
        try:    
            transformed_df=self.transform_data(X) # Apply transform on x data
...
class DataTransformation:
    ...
    def get_data_transformation_obj(self):
        try:
            ...
            # ordinal Pipeline(Temperature:- High , medium , low )
    ...
    def get_feature_engineering_object(self):
        try:
            feature_engineering = Pipeline(steps = [("fe",Feature_Engineering())]) # Call the feature engineering class
            return feature_engineering # Complete feature engineering class function
    ...
    def inititate_data_transformation(self, train_path, test_path):
        try:
            ...
            fe_obj = self.get_feature_engineering_object() # Call the feature engineering part
            ...
            processinf_obj = self.get_data_transformation_obj() # Call the data transformation part
            ...
            # combining two datasets (X and y) into a single array after transformation
            ...
            ### Save the feature engineering file
